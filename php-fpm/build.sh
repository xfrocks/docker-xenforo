...
RUN_PACKAGES="$RUN_PACKAGES icu-libs"           # intl
TMP_PACKAGES="$TMP_PACKAGES icu-dev"            # intl
TMP_PACKAGES="$TMP_PACKAGES libgcrypt-dev"      # xsl
...
RUN_PACKAGES="$RUN_PACKAGES libxslt"            # xsl
TMP_PACKAGES="$TMP_PACKAGES libxslt-dev"        # xsl
